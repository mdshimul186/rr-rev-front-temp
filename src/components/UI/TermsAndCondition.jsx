...
/**
 * TermsAndConditionModal component displays the terms and conditions for the application.
 * It provides a detailed view of the terms, allowing users to read and accept them.
 *
 ...
 * @returns {JSX.Element} The rendered terms and conditions modal.
 */
export const TermsAndConditionModal = ({ isOpen, onRequestClose }) => {
  ...
  return (
    <Modal show={isOpen} onHide={onRequestClose} size="lg" animation={true}>
      <Modal.Header closeButton>
        <Modal.Title>{title}</Modal.Title>
      </Modal.Header>
      <Modal.Body className="fixed_modal_height">
        <h5 className="policy-heading">{resident_review}</h5>
        <h5 className="policy-heading">{terms_of_service}</h5>
        <h5 className="policy-heading">{effective_date}</h5>
        <p>{heading}</p>
        ...
        <p>
          {f} <strong>{content_moderation}</strong> {content_moderation_text}
        </p>
        <p>
        ...
        <p>
          {b} <strong>{additional_term} </strong> {additional_term_text}
        </p>
        <p>
          <strong>{suggestions}</strong> {suggestions_text}
        </p>
        <p>
          <strong>{third_party_content}</strong> {third_party_content_text}
        </p>
        <p>
